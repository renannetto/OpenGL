...
#define CAUDA_SUP_COMP TORSO_COMP/3.0
#define CAUDA_SUP_ALT TORSO_ALT/2.0
#define CAUDA_SUP_LARG CAUDA_SUP_ALT

#define CAUDA_MEIO_COMP CAUDA_SUP_COMP*0.8
#define CAUDA_MEIO_ALT CAUDA_SUP_ALT
#define CAUDA_MEIO_LARG CAUDA_SUP_LARG

#define CAUDA_INF_COMP CAUDA_SUP_COMP*0.7
