...
void Animacao::andar() {
	...
	angulos_add[PATA_ESQ_1][0][Y] = pata_esq_1_sup_Y / FRAMES;
	angulos_add[PATA_ESQ_2][0][Y] = pata_esq_2_sup_Y / FRAMES;
	angulos_add[PATA_ESQ_3][0][Y] = pata_esq_3_sup_Y / FRAMES;
	angulos_add[PATA_ESQ_4][0][Y] = pata_esq_4_sup_Y / FRAMES;

	angulos_add[PATA_DIR_1][0][Y] = pata_dir_1_sup_Y / FRAMES;
	angulos_add[PATA_DIR_2][0][Y] = pata_dir_2_sup_Y / FRAMES;
	angulos_add[PATA_DIR_3][0][Y] = pata_dir_3_sup_Y / FRAMES;
	angulos_add[PATA_DIR_4][0][Y] = pata_dir_4_sup_Y / FRAMES;
